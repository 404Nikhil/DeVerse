...
const Footer = () => {
    return (
        <footer className="flex flex-col relative items-center justify-between border-t border-border pt-16 pb-8 px-6 lg:px-8 w-full max-w-6xl mx-auto lg:pt-32">
            ...
            <div className="grid gap-8 xl:grid-cols-3 xl:gap-8 w-full">
                ...
                <div className="flex flex-col items-start justify-start md:max-w-[200px]">
                    ...
                    <Image src="/assets/osslogo.svg" alt="OSS Logo" width={28} height={28} className="w-7 h-7" />                    </div>
